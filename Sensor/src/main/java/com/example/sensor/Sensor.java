...
public class Sensor {
    ...
    public String generateData() throws JsonProcessingException {
        double soilMoisture = generateTemperature(20.0, 60.0);
        double soilTemperature = generateTemperature(5.0, 30.0);
        double ph = generateTemperature(7.0, 7.5);
        double airTemperature = generateTemperature(20.0, 35.0);
        double airHumidity = generateTemperature(30.0, 60.0);
